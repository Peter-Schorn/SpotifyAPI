...
extension SpotifyAPITrackTests {
    ...
    func trackAudioFeatures() {
        ...
        func receiveTrack(_ track: AudioFeatures) {
            ...
            XCTAssertEqual(track.danceability, 0.275, accuracy: 0.001)
            XCTAssertEqual(track.energy, 0.216, accuracy: 0.001)
            XCTAssertEqual(track.key, 5)
            XCTAssertEqual(track.loudness, -13.818, accuracy: 0.001)
            XCTAssertEqual(track.mode, 1)
            XCTAssertEqual(track.speechiness, 0.0345, accuracy: 0.001)
            XCTAssertEqual(track.acousticness, 0.768, accuracy: 0.001)
            XCTAssertEqual(track.instrumentalness, 0.897, accuracy: 0.001)
            XCTAssertEqual(track.liveness, 0.0832, accuracy: 0.001)
            XCTAssertEqual(track.valence, 0.181, accuracy: 0.001)
            XCTAssertEqual(track.tempo, 116.388, accuracy: 0.001)
    ...
    func tracksAudioFeatures() {
        ...
        func receiveTracks(_ tracks: [AudioFeatures?]) {
            ...
            if let track = tracks[0] {
                ...
                XCTAssertEqual(track.energy, 0.579, accuracy: 0.001)
                XCTAssertEqual(track.key, 10)
                XCTAssertEqual(track.loudness, -10.765, accuracy: 0.001)
                XCTAssertEqual(track.mode, 1)
                XCTAssertEqual(track.speechiness, 0.0406, accuracy: 0.001)
                XCTAssertEqual(track.acousticness, 0.0591, accuracy: 0.001)
                XCTAssertEqual(track.instrumentalness, 0.746, accuracy: 0.001)
                XCTAssertEqual(track.liveness, 0.0686, accuracy: 0.001)
                XCTAssertEqual(track.valence, 0.135, accuracy: 0.001)
                XCTAssertEqual(track.tempo, 68.102, accuracy: 0.001)
                XCTAssertEqual(track.type, "audio_features")
            ...
            if let track = tracks[1] {
                XCTAssertEqual(track.danceability, 0.322, accuracy: 0.001)
                ...
                XCTAssertEqual(track.instrumentalness, 0.34, accuracy: 0.001)
                XCTAssertEqual(track.liveness, 0.366, accuracy: 0.001)
                XCTAssertEqual(track.valence, 0.207, accuracy: 0.001)
                XCTAssertEqual(track.tempo, 133.577, accuracy: 0.001)
                XCTAssertEqual(track.type, "audio_features")
